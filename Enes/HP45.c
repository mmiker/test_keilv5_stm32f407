...
void InitHp45(void)
{
	...
	conf_GPIO(HP45_ADDRESS_GPIO  , HP45_ADDRESS_CLOCK | HP45_ADDRESS_RESET, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP, GPIO_Speed_50MHz);							// GPIOx konfigurasyonu için ozel fonksiyon
